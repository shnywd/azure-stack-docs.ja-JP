...
* リソースを作成して管理するため、Azure Stack Hub には Azure PowerShell の特定のバージョンが必要です。 Azure Stack Hub 用に構成された PowerShell がない場合は、PowerShell を[インストール](../operator/powershell-install-az-module.md)する手順に従います。
