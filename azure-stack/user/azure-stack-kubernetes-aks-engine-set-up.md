...
> [!Note]  
> [Azure Stack Hub 用の Azure CLI](./azure-stack-version-profiles-azurecli2.md) または [Azure Stack Hub PowerShell](../operator/powershell-install-az-module.md) で AKS エンジンを使用するための前提条件を作成することもできます。
