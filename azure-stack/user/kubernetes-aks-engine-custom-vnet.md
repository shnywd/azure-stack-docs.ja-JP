...
## <a name="set-the-route-table-and-network-security-group"></a>ルート テーブルとネットワーク セキュリティ グループを設定する
...
6. **[ネットワーク セキュリティ グループ]** を選択し、クラスターの NSG を選択します。
