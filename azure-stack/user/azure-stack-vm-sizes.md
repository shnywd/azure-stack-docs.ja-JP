...
|-----------------|-----|---------|---------|-----|------|-----------|----|
|**A0\Basic_A0**  |1    |768 MB   | 20 GB   |該当なし  | 該当なし  |1 / 1x300  |2   |
|**A1\Basic_A1**  |1    |1.75 GB  | 40 GB   |該当なし  | 該当なし  |2 / 2x300  |2   |
|**A2\Basic_A2**  |2    |3.5 GB   | 60 GB   |該当なし  | 該当なし  |4 / 4x300  |2   |
|**A3\Basic_A3**  |4    |7 GB     | 120 GB  |該当なし  | 該当なし  |8 / 8x300  |2   |
|**A4\Basic_A4**  |8    |14 GB    | 240 GB  |該当なし  | 該当なし  |16 / 16X300 |2   |
