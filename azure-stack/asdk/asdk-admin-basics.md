...
> [!NOTE]
> プラン、オファー、およびサービスをテストする場合は、[管理者ポータル](https://portal.local.azurestack.external)ではなく[ユーザー ポータル](https://adminportal.local.azurestack.external)を使用する必要があります。
