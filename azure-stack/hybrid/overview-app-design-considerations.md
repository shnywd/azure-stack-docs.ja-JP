...
| データ インジェスト | データはさまざまな方法でアプリケーションに送信でき、ユーザーが Web フォームで送信した値や、継続的な大量のデータフローなどがあります。 |
...
| Security | 脅威からハイブリッド アプリケーションとデータを保護することです。 |
