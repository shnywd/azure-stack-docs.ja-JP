...
> [!NOTE]
> 複数の Azure Stack がある場合のベスト プラクティスは、各 Azure Stack を専用のサブスクリプションに登録することです。 これにより、使用状況の追跡が容易になります。
...
最新バージョンがまだインストールされていない場合は、「[PowerShell for Azure Stack をインストールする](azure-stack-powershell-install.md)」を参照してください。
