...
3. [Azure Resource Manager テンプレートを作成する](/azure/azure-resource-manager/resource-group-authoring-templates)か、GitHub からテンプレートを選択します。 Marketplace アイテムでは、このテンプレートを使用して新しいリソースを作成します。
