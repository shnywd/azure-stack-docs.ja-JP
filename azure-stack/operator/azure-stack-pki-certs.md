---
title: Azure Stack Hub の証明書署名要求を作成する
description: Azure Stack Hub 統合システムにおいて Azure Stack Hub PKI 証明書の証明書署名要求を作成する方法について学習します。
...
ms.locfileid: "86419162"
---
# <a name="create-certificate-signing-requests-for-azure-stack-hub"></a>Azure Stack Hub の証明書署名要求を作成する
...
- [新しいデプロイのための証明書署名要求の生成](azure-stack-get-pki-certs.md)の説明に従った、**標準の証明書要求**。
- [証明書更新のための証明書署名要求の生成](azure-stack-get-pki-certs.md)の説明に従った、**証明書要求の更新**。
