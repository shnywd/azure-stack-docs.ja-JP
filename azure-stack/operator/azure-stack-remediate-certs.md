...
**解決策** - [デプロイ用の Azure Stack PKI 証明書の準備](azure-stack-prepare-pki-certs.md#prepare-certificates-for-deployment)に関するページの手順を使用して、CSR を生成したコンピューターから証明書を再度エクスポートします。 この手順には、ローカル コンピューターの証明書ストアからのエクスポートが含まれます。
